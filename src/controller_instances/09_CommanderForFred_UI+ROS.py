...
# Model is a single SerialCommanderFred() object
...
def get_checkbox_selected_clamps(guiref, commander: SerialCommanderFred):
...
def handle_background_commands(guiref, commander: SerialCommanderFred, q):
